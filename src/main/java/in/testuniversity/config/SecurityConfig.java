    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
    	return http
		    		...
		    		.authorizeHttpRequests(auth -> auth
		    				.requestMatchers("/login", "/register", "/public/**").permitAll() //Public end   point login permitted
		    				.anyRequest().authenticated() //Securing all endpoint requests by authenticating
		    		)
